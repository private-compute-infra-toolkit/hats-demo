...
setup_tvs_keys() {
  ...
  echo '04a99c16a302716404b075086c8c125ea93d0822330f8a46675c8f7e5760478024811211845d43e6addae5280660ba3b5ba0f78834b79ec9449b626a725728b76d' > ta_hats_stack/orchestrator_hold_noise_kk_public_key_hex
  ...
  echo $AUTH_KEYS | awk '{split($0,a," "); print a[4]}' > ta_hats_stack/launcher_hold_user_authentication_private_key_hex
  popd
...
setup_virtual_bridge_networking() {
