...
runuser -u optsuser -- bazel --output_base=/home/optsuser/ build -c opt //client/system_image:hats_system_image --//:syslogd_source=binary
cp /home/optsuser/execroot/_main/bazel-out/k8-opt/bin/client/system_image/hats_system_image.tar "$TAR_DIR/"
